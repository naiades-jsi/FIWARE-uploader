        ...
        for i in self.mask:
            ...
            if (self.format == "v2"):
                ...
                data_model["dateCreated"]["value"] = {
                    "@type": "DateTime",
                    "@value": (prediction_time_timestamp).replace(minute=0, second=0, microsecond=0).isoformat("T", "seconds") + "Z"
                }
                ...
                data_model["consumptionTo"]["value"] = {
                    "@type": "DateTime",
                    "@value": (to_time_timestamp).replace(minute=0, second=0, microsecond=0).isoformat("T", "seconds") + "Z"
                }
            else:
